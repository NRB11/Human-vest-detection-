...
def has_black_shirt(image, landmarks):
    ...
    center_x = int(landmarks.landmark[11].x * width)  # LEFT_SHOULDER
    center_y = int(landmarks.landmark[11].y * height) # LEFT_SHOULDER
...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        ...
        if has_black_shirt(image, results.pose_landmarks):
            ...
            cv2.putText(image, 'No Black T-shirt Detected', (50, 50),
